...
public final class Shape {
    ...
    public Shape(JavaPlugin plugin, String name, boolean shaped, @NotNull List<String> ingredients, List<String> shape, ItemStack result) {
        this.plugin = plugin;
        this.name = name;
        this.shaped = shaped;
    ...
    public void register(ItemStack item) {
        ...
        if (!Bukkit.addRecipe(recipe)) {
            ...
            plugin.getLogger().info("Registered new recipe {" + name + "}!");
        }
    }
}